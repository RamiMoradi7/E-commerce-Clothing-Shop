...
export const SizeIcon: React.FC<SvgIconProps> = (props) => (
  <SvgIcon {...props}>
    <FormatSizeSharp />
  </SvgIcon>
);

export const ColorIcon: React.FC<SvgIconProps> = (props) => (
  <SvgIcon {...props}>
    <ColorLens />
  </SvgIcon>
);
export const AudienceIcon: React.FC<SvgIconProps> = (props) => (
  <svg
    {...props}
